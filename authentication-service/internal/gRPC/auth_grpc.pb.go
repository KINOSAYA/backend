...
func (c *authServiceClient) RegisterUser(ctx context.Context, in *User, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
...
func (UnimplementedAuthServiceServer) RegisterUser(context.Context, *User) (*User, error) {
