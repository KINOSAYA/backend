...
type AuthServiceClient interface {
	...
	Refresh(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*TokenRequest, error)
}
...
func (c *authServiceClient) Refresh(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*TokenRequest, error) {
...
type AuthServiceServer interface {
	...
	Refresh(context.Context, *TokenRequest) (*TokenRequest, error)
...
func (UnimplementedAuthServiceServer) Refresh(context.Context, *TokenRequest) (*TokenRequest, error) {
